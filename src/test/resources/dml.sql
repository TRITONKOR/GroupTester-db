...
INSERT INTO users (id, username, password, email, birthday, role)
VALUES ('5c2a6d9b-8a32-4366-ad16-ca14f387c564', 'user1', 'password1', 'user1@example.com', '1990-01-01', 'STUDENT'),
       ('ce8e1de3-ebc1-4332-b696-e2b4d7c94400', 'user2', 'password2', 'user2@example.com', '1992-03-15', 'STUDENT'),
       ('acf647ec-b69c-43cc-86fd-96628a1fb40a', 'user3', 'password3', 'user3@example.com', '1985-07-20', 'TEACHER');
...
-- Призначення тестів користувачам
INSERT INTO user_test (user_id, test_id)
VALUES ('5c2a6d9b-8a32-4366-ad16-ca14f387c564', '3552c844-e5dc-4135-a4ff-b0bb148ee2af'),
       ('ce8e1de3-ebc1-4332-b696-e2b4d7c94400', '3552c844-e5dc-4135-a4ff-b0bb148ee2af'),
       ('5c2a6d9b-8a32-4366-ad16-ca14f387c564', 'fd1476e6-eed2-45d8-b975-8f713e916d9c');
